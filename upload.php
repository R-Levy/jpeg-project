...
fclose($file);
$target_dir = mkdir("Tasks/".$counter."/");
$dir = "Tasks/".$counter."/";
$target_file = $dir."source.jpg";
$uploadOk = 1;
...
// redirect with passing variables through url
header("Location: choose.php? counter=$counter");

//now update counter file for next user 
